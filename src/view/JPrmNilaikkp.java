 ...
 * @author fadhl
 */
public class JPrmNilaikkp extends javax.swing.JFrame {
    JasperReport jasRep;
   ...
   private void getcbTempatkkp() {
    ...
    // Update query to include mahasiswa.jurusan
    String query = "SELECT DISTINCT mahasiswa.jurusan " + // Use DISTINCT to avoid duplicate entries
                   "FROM evaluasi_kkp " +
    ...
    try {
        ...
        if (conn != null && !conn.isClosed()) {
            ...
            while (rs.next()) {
                model.addElement(rs.getString("jurusan")); // Get jurusan from result set
            }
    ...
    try {
        ...
        // Load the JRXML file
        File reportFile = new File("src/report/repNilaikkp.jrxml");
        ...
        if (ckbAll.isSelected()) {
            ...
            String selectedPerusahaan = (String) cbJurusan.getSelectedItem();
            parameterValue = (selectedPerusahaan != null && !selectedPerusahaan.isEmpty()) ? selectedPerusahaan : null;
        }

        // Set parameters
        Map<String, Object> parameters = new HashMap<>();
        parameters.put("rkkp", parameterValue);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JPrmNilaikkp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JPrmNilaikkp().setVisible(true);
            }
        });
    }
